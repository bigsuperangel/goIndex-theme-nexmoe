 ...
 */
// 在head 中 加载 必要静态
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/bigsuperangel/goIndex-theme-nexmoe@1.1.3/css/mdui_v2.min.css">');
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/bigsuperangel/goIndex-theme-nexmoe@1.1.4/css/nexmoe_v2.min.css">');
document.write('<script src="//cdn.jsdelivr.net/gh/bigsuperangel/goIndex-theme-nexmoe@1.1.3/js/mdui.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/bigsuperangel/goIndex-theme-nexmoe@1.1.5/js/flv.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/bigsuperangel/goIndex-theme-nexmoe@1.1.5/js/DPlayer.min.js"></script>');
// markdown支持
document.write('<script src="//cdn.jsdelivr.net/gh/bigsuperangel/goIndex-theme-nexmoe@1.1.3/js/markdown-it.min.js"></script>');
...
<header class="nexmoe-nav">
	<div class="navSize">
			<a href="/"><img class="avatar" src="https://www.flaticon.com/premium-icon/icons/svg/2504/2504719.svg"/></a>
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://keepway.ga/" target="_blank">博客</a></li>
